    ...
    $(document).ready(function() {
      @if(session('success'))
          $.notify({
              ...
              type: 'success', // You can change this to other types like 'warning', 'danger', etc.
              timer: 8000,
              placement: {
                  from: 'top', // Change this to 'bottom' if you want it at the bottom
                  align: 'right' // Change to 'left' or 'center' if needed
              }
          });
      @endif
      $().ready(function() {
